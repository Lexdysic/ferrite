...
//=============================================================================
float32 Min (const Point2 & v)
{
    return Min(v.x, v.y);
}

//=============================================================================
float32 Min (const Point3 & v)
{
    return Min(v.x, v.y, v.z);
}

//=============================================================================
Point2 Min (const Point2 & a, const Point2 & b)
{
    return Point2(
        Min(a.x, b.x),
        Min(a.y, b.y)
...
//=============================================================================
float32 Max (const Point2 & v)
{
    return Max(v.x, v.y);
}

//=============================================================================
float32 Max (const Point3 & v)
{
    return Max(v.x, v.y, v.z);
}

//=============================================================================
Point2 Max (const Point2 & a, const Point2 & b)
{
    return Point2(
        Max(a.x, b.x),
        Max(a.y, b.y)

...
{
    Point3  c = (Vector3(box.min) + box.max) * 0.5f;    // Box center
    Vector3 e = box.max - c;                            // Box half-length
    Point3  m = (Vector3(line.a) + line.b) * 0.5f;      // Segment mid-point
    Vector3 d = line.b - m;                             // Segment half-length
...
{
    Point2  c = (Vector2(box.min) + box.max) * 0.5f;    // Box center
    Vector2 e = box.max - c;                            // Box half-length
    Point2  m = (Vector2(line.a) + line.b) * 0.5f;      // Segment mid-point
    Vector2 d = line.b - m;                             // Segment half-length
